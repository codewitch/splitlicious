package com.venmo.android.splitlicious.api; //Replace this with the name of your package
...
{
    private static final String TAG = "venmo_library";
    ...
    /*
     * Takes in permissions and returns an Intent object
     */
    public static Intent openVenmoLogin(String myAppId, String myAppName, String permissions) {

        String venmo_uri = "venmosdk://login?";

        venmo_uri += getParamQuery("app_id", myAppId)
                + getParamQuery("app_name", myAppName);
	...
	public static Intent openVenmoPayment(String myAppId, String myAppName, String recipients, String amount, String note, String txn)
	{
    	...
    	if (!recipients.equals("")) {
    		try {
				...
				Log.e(TAG, "cannot encode recipients");
			}
    	}
    	if (!amount.equals("")) {
    		try {
				...
				Log.e(TAG, "cannot encode amount");
			}
    	}
    	if (!note.equals("")) {
    		try {
    	...
    	{
    		Log.e(TAG, "cannot encode app ID");
    	}
    	...
    	{
    		Log.e(TAG, "cannot encode app Name");
    	}
    	...
    	{
    		Log.e(TAG, "cannot encode app local id");
    	}
	...
	public static String openVenmoPaymentInWebView(String myAppId, String myAppName, String recipients, String amount, String note, String txn)
	{
    	...
    	{
    		Log.e(TAG, "cannot encode client=android");
    	}
    ...
    private static String getParamQuery(String key, String value) {
